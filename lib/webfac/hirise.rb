# Base: SITE = http://660cb57c0b563d15320a152de472c85b4c63335b:X@http//mstramba.h
# ighrisehq.com/
#irb(main):001:0> p = Highrise::Person.find(1)

#SocketError: getaddrinfo: no address associated with hostname.
#        from d:/ruby/InstantRails/ruby/lib/ruby/1.8/net/http.rb:560:in `initiali
#
#
#
# set SITE=http://660cb57c0b563d15320a152de472c85b4c63335b:X@http://mstramba.highrisehq.com/
#
# irb -r highrise.rb
# irb(main):001:0> david = Highrise::Person.find(1)
# irb(main):002:0> david.name
...
module Highrise
  ...
  class Base < ActiveResource::Base
    self.site = ENV['SITE']
    #self.site = 'http://660cb57c0b563d15320a152de472c85b4c63335b:X@http://mstramba.highrisehq.com/'
    print "\n Base: SITE = #{self.site}\n"
  end
